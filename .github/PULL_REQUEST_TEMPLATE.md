...
- If public SDK APIs changed, update TypeScript types, README snippets, examples, or tests when relevant.
- If signing, authentication, RFQ, order building, order utilities, or HTTP behavior changed, include focused regression coverage whenever feasible.
...
- [ ] I ran `pnpm install --frozen-lockfile`, or dependency changes were intentional and `pnpm-lock.yaml` is updated.
- [ ] I ran `pnpm lint`.
- [ ] I ran `pnpm build`.
- [ ] I ran `pnpm test`.
