...
export const GET_MARKETS_BY_TOKEN = '/markets-by-token/'
...
export const GET_RFQ_REQUESTER_QUOTES = '/rfq/data/requester/quotes'
export const GET_RFQ_QUOTER_QUOTES = '/rfq/data/quoter/quotes'
